...
class FunAndLearnTitleScreencourse extends StatefulWidget {
  const FunAndLearnTitleScreencourse({
  ...
  @override
  State<FunAndLearnTitleScreencourse> createState() => _FunAndLearnTitleScreencourse();

  static Route<dynamic> route(RouteSettings routeSettings) {
    final arguments = routeSettings.arguments! as Map;
    return CupertinoPageRoute(
      builder: (_) => FunAndLearnTitleScreencourse(
...
class _FunAndLearnTitleScreencourse extends State<FunAndLearnTitleScreencourse> {
  @override
  void initState() {
    super.initState();
    getComprehension();
