...
final class CategoryScreenCourseArgs extends RouteArgs {
  const CategoryScreenCourseArgs({required this.quizType});

  final QuizTypes quizType;
}

class CategoryScreenCourse extends StatefulWidget {
  const CategoryScreenCourse({required this.args, super.key});

  final CategoryScreenCourseArgs args;

  @override
  State<CategoryScreenCourse> createState() => _CategoryScreenCourse();

  static Route<dynamic> route(RouteSettings routeSettings) {
    final args = routeSettings.args<CategoryScreenCourseArgs>();

    return CupertinoPageRoute(builder: (_) => CategoryScreenCourse(args: args));
  }
}

class _CategoryScreenCourse extends State<CategoryScreenCourse> {
